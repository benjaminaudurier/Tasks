#ifndef ALIANALYSISTASKMUONTRACKINGEFFLOCAL_H
#define ALIANALYSISTASKMUONTRACKINGEFFLOCAL_H
...
/// \ingroup base
/// \class AliAnalysisTaskMuonTrackingEffLocal
...
class AliAnalysisTaskMuonTrackingEffLocal : public AliAnalysisTaskSE
{
  
 public:
  
  AliAnalysisTaskMuonTrackingEffLocal();
  AliAnalysisTaskMuonTrackingEffLocal(TString name);
  virtual ~AliAnalysisTaskMuonTrackingEffLocal();
 ...
 private:
  ...
  /// Not implemented
  AliAnalysisTaskMuonTrackingEffLocal(const AliAnalysisTaskMuonTrackingEffLocal& rhs);
  /// Not implemented
  AliAnalysisTaskMuonTrackingEffLocal& operator = (const AliAnalysisTaskMuonTrackingEffLocal& rhs);
...
private:
  ...
  AliCounterCollection* fCounts; //!< Number of event couted
  ...
  ClassDef(AliAnalysisTaskMuonTrackingEffLocal, 1)
  
};


//________________________________________________________________________
inline void AliAnalysisTaskMuonTrackingEffLocal::SetMuonTrackCuts(AliMuonTrackCuts &trackCuts)
{
  /// set standard cuts to select tracks to be considered
