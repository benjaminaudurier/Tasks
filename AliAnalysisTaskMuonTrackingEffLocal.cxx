...
#include "AliAnalysisTaskMuonTrackingEffLocal.h"
...
ClassImp(AliAnalysisTaskMuonTrackingEffLocal)

const Int_t AliAnalysisTaskMuonTrackingEffLocal::fgkNofDE[11] = {4, 4, 4, 4, 18, 18, 26, 26, 26, 26, 156};
const Int_t AliAnalysisTaskMuonTrackingEffLocal::fgkNofBusPath = 888;
const Int_t AliAnalysisTaskMuonTrackingEffLocal::fgkNofManu = 16828;

//________________________________________________________________________
AliAnalysisTaskMuonTrackingEffLocal::AliAnalysisTaskMuonTrackingEffLocal() :
  AliAnalysisTaskSE(),
  fOCDBLoaded(kFALSE),
  fOCDBpath(""),
  fAlignOCDBpath(""),
...
//________________________________________________________________________
AliAnalysisTaskMuonTrackingEffLocal::AliAnalysisTaskMuonTrackingEffLocal(TString name) :
...
//________________________________________________________________________
void AliAnalysisTaskMuonTrackingEffLocal::NotifyRun()
{
...
//________________________________________________________________________
void AliAnalysisTaskMuonTrackingEffLocal::UserCreateOutputObjects()
{
  ...
  fCounts = new AliCounterCollection(GetOutputSlot(2)->GetContainer()->GetName());
  fCounts->AddRubric("Counts", "NofEvent");
  fCounts->Init();
...
//________________________________________________________________________
void AliAnalysisTaskMuonTrackingEffLocal::UserExec(Option_t *)
{
  /// Main event loop
...
//________________________________________________________________________
void AliAnalysisTaskMuonTrackingEffLocal::Terminate(Option_t *)
{
  /// final plots
...
//________________________________________________________________________
Bool_t AliAnalysisTaskMuonTrackingEffLocal::TagRemovableClusters(AliMUONTrack &track, Bool_t removableChambers[10])
{
...
//________________________________________________________________________
void AliAnalysisTaskMuonTrackingEffLocal::FindAndRecordMissingClusters(AliMUONTrackParam &param, Int_t chamber,
...
//________________________________________________________________________
void AliAnalysisTaskMuonTrackingEffLocal::Intersect(AliMUONTrackParam &param, Int_t deId, Double_t p[3])
{
...
//________________________________________________________________________
Bool_t AliAnalysisTaskMuonTrackingEffLocal::OverlapDE(AliMpArea &area, Int_t deId)
{
...
//________________________________________________________________________
void AliAnalysisTaskMuonTrackingEffLocal::RecordCluster(Int_t chamber, Int_t deId, AliMpPad pad[2], Double_t trackInfo[6],
...
//________________________________________________________________________
Bool_t AliAnalysisTaskMuonTrackingEffLocal::FindPads(Int_t deId, Double_t pos[3], AliMpPad pad[2])
{
